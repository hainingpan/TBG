...
line(klist([40,40]),[-200,30],'color','k','LineStyle','--');
line(klist([80,80]),[-200,30],'color','k','LineStyle','--');
line(klist([120,120]),[-200,30],'color','k','LineStyle','--');
% line(klist([200,200]),[-200,30],'color','k','LineStyle','--');
